...
const ALL_BADGES = [
  ...
  },
  {
    ...
    emoji: "📖",
    name: "Word Master",
    desc: "Complete 5 English lessons",
    category: "Subjects",
    unlocked: false,
    xp: 120,
  },
  {
    ...
    emoji: "🔬",
    name: "Scientist",
    desc: "Complete 5 Science lessons",
    category: "Subjects",
    unlocked: false,
    xp: 120,
  },
  ...
  },
  {
    ...
    emoji: "📚",
    name: "Book Worm",
    desc: "Complete 10 lessons total",
    category: "Learning",
    unlocked: false,
    xp: 150,
  },
  ...
  },
  {
    ...
    emoji: "❤️",
    name: "Parent's Joy",
    desc: "Get praised by your parent",
    category: "Special",
    unlocked: false,
    xp: 200,
  },
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="card-fun p-5">
          ...
          <div className="h-3 bg-gray-100 rounded-full overflow-hidden">
            <div
              className="h-full rounded-full bg-gradient-to-r from-yellow-400 to-fun-orange transition-all duration-1000"
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {ALL_BADGES.map((badge) => (
            <div
              key={badge.id}
              className={`card-fun p-4 text-center relative overflow-hidden hover:-translate-y-1 transition-transform ${!badge.unlocked ? "opacity-60 grayscale" : ""}`}
            >
              {!badge.unlocked && (
              ...
              <div className="mt-2 flex items-center justify-center gap-1">
                ...
                <span className="text-xs font-bold text-fun-orange">
                  +{badge.xp} XP
                </span>
              </div>
              {badge.unlocked && (
