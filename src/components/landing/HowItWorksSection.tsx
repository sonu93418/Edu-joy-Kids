      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-gray-500 max-w-xl mx-auto text-base">
            From signup to first lesson in under 5 minutes — intuitive for
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-14 relative">
          ...
          {STEPS.map(({ n, icon: Icon, title, desc, color }) => (
            ...
            >
              <div
                className={`w-16 h-16 ${color} rounded-2xl flex items-center justify-center mb-4 shadow-sm`}
              >
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-8 sm:p-10 flex flex-col md:flex-row gap-10 items-start">
          <div className="flex-1">
            ...
            <p className="text-gray-500 text-sm mb-5">
              ...
              Parents stay in control while kids enjoy learning like never
              before.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {HIGHLIGHTS.map((label) => (
                ...
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-edujoy-primary-500 flex-shrink-0" />
                  {label}
                </div>
              ))}
            </div>
          ...
          <div className="flex-shrink-0 self-center">
            <Link
              href="/auth/signup"
              className="inline-flex items-center gap-2 bg-edujoy-primary-600 text-white font-bold px-7 py-3.5 rounded-xl hover:bg-edujoy-primary-700 transition-colors"
            >
