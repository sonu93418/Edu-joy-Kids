...
export const validateGrade = body('grade')
  .isIn(['play_group', 'nursery', 'lkg', 'ukg', 'class_1', 'class_2', 'class_3', 'class_4', 'class_5'])
...
export const validateLesson = [
  ...
  body('subject').isIn(['english', 'math', 'science', 'evs', 'gk', 'hindi']).withMessage('Please provide a valid subject'),
  validateGrade.withMessage('Please provide a valid grade'),
  body('lessonType').isIn(['animated', 'interactive', 'quiz', 'story', 'game', 'practice']).withMessage('Please provide a valid lesson type'),
  body('difficulty').isIn(['easy', 'medium', 'hard']).withMessage('Please provide a valid difficulty level'),
  body('duration.estimated').isInt({ min: 1, max: 180 }).withMessage('Estimated duration must be between 1 and 180 minutes'),
  handleValidationErrors
];
...
export const validatePayment = [
  body('plan').isIn(['basic', 'premium', 'school_basic', 'school_premium']).withMessage('Please provide a valid plan'),
  body('paymentMethod').isIn(['stripe', 'razorpay', 'paypal']).withMessage('Please provide a valid payment method'),
  handleValidationErrors
];
